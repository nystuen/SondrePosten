  ...
  render() {
    return (
      <div>
        ...
        <button className="btn btn-primary" data-toggle="collapse" data-target="#collapseExample2"
                aria-expanded="false" aria-controls="collapseExample2">Legg til en kommentar
        </button>
        ...
        <div className="collapse" id="collapseExample2">
          <div className="card detailBox form-group">
            ...
            <div className="card-block">
              ...
              <button onClick={() => {
                this.handleSubmit();
              }} className="btn btn-light" data-toggle="collapse" data-target="#collapseExample2"
                      aria-expanded="false" aria-controls="collapseExample2">Legg ut kommentar
              </button>
            </div>
          </div>
        </div>
